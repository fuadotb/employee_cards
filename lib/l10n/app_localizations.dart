...
abstract class AppLocalizations {
  ...
  /// No description provided for @enterEmployeeNumber.
  ///
  /// In en, this message translates to:
  /// **'Enter employee number'**
  String get enterEmployeeNumber;
  ...
  ///
  /// In en, this message translates to:
  /// **'Employee data was not found'**
  String get employeeNotFound;

  /// No description provided for @pleaseEnterEmployeeNumber.
  ///
  /// In en, this message translates to:
  /// **'Please enter the employee number'**
  String get pleaseEnterEmployeeNumber;
